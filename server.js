...
<style>
  ...
  *{box-sizing:border-box; -webkit-tap-highlight-color:transparent;}
  ...
  .scroll-hint{position:absolute;left:50%;bottom:10px;transform:translateX(-50%);
...
<div class="app" id="app">
  ...
  <div class="view" id="viewPlinko">
    ...
    <div class="stairs-stage" id="plinkoStage">
      ...
      <div class="scroll-hint" id="plinkoScrollHint">▼ Листай вниз — там ставка ▼</div>
    </div>
    <div class="controls">
...
// Scroll hint: visible by default (the tall board can easily push the bet
// controls below the fold), fades out once the player actually scrolls
// #viewPlinko down a bit — so it doesn't linger once they've found the
// controls once.
...
if(plinkoViewEl && plinkoScrollHint){
  plinkoViewEl.addEventListener('scroll', () => {
    plinkoScrollHint.style.opacity = plinkoViewEl.scrollTop > 24 ? '0' : '1';
  });
}
