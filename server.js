...
// =====================================================================
function setVh(){
  // Skip while typing: recalculating here while the on-screen keyboard is
  // opening/closing was fighting with it — the layout shift on focus was
  // blurring the field, which closed the keyboard, which reverted the
  // layout, which re-triggered this... an open/close loop on every tap.
