...
let stairs = {
  ...
  launchTs:0, boosted:false, colorBonusAccum:0, lowGravUntilTs:0, preLowGravVx:0, preLowGravVy:0,
...
function stairsUpdateLowGravity(){
  ...
  if(performance.now() >= stairs.lowGravUntilTs){
    ...
    // Snap speed back to whatever it was the moment lowgrav was triggered —
    // requested specifically because normal gravity suddenly returning
    // mid-flight was making bounces immediately afterward feel like a hard
    // speed cut compared to how far low gravity had been carrying it.
