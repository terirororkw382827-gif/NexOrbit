...
function renderStairsLeaderboard(top){
  ...
  if(!top || !top.length){ stairsLeaderboardEl.innerHTML = '<div class="empty-note">Сегодня ещё никто не выбил множитель</div>'; return; }
  stairsLeaderboardEl.innerHTML = top.map(e => {
