...
const STAIRS_HOP_VX_BASE = 9;      // px/step — horizontal launch speed at perfect aim+power (was 7.5)
const STAIRS_HOP_VY0_BASE = 9;     // px/step — upward launch speed at perfect aim+power (was 6.2;
