...
function plinkoBuildBoard(){
  ...
  // Pinned right at the very top of the canvas (just enough offset that
  // its own thickness doesn't clip above y=0) rather than tucked in above
  // the peg triangle — the ball's spawn point is unchanged/untouched.
  const roofThickness = outerWallThickness;
  const roofY = roofThickness/2 + 2;
  plinkoWallBodies.push(
