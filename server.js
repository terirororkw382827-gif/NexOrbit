...
const PLINKO_MULTS = [10,5,3,2,1.5,1,0,1,1.5,2,3,5,10];
const PLINKO_SLOT_COLORS = ['#ffd23f','#ff9f1c','#ff6b35','#ff3d5a','#e0507a','#8d8d99','#3a3a45','#8d8d99','#e0507a','#ff3d5a','#ff6b35','#ff9f1c','#ffd23f'];
...
function plinkoBuildBoard(){
  ...
  plinkoBoard = { w, h, marginX, boardW, slotW, centerX, topY, rowGapY, bottomOfPegsY, slotAreaH, pegR, ballR, wallTopY };
}
